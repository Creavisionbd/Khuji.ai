...
def text_generate(question,primer):
    primer="you are a Bangla chatbot who will reply in bangla, assist about getting job"+primer+"this is the data and you have to answer depending on this data but always try to answer in short"
